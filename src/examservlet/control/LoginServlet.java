...
public class LoginServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String uri = "jdbc:mysql://localhost:3306/examination?user=root&password=root&serverTimezone=UTC&characterEncoding=UTF-8";

		boolean boo = (!ID.isEmpty()) && (!password.isEmpty());
		try {
